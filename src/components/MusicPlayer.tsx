    ...
    <>
      ...
      <motion.div
        ...
        animate={{
          width: playerWidth,
          height:
            playerMode === "minimized" ? "auto" : playerMode === "maximized" ? "32rem" : "auto",
        ...
        `}
        style={{
          right: playerMode === "minimized" ? (anchored === "right" ? "1.5rem" : "auto") : "1.5rem",
          left: playerMode === "minimized" ? (anchored === "left" ? "1.5rem" : "auto") : "auto",
          bottom: playerMode === "minimized" ? "1.5rem" : "1.5rem",
          pointerEvents: isHidden && playerMode === "minimized" ? "none" : "auto",
        }}
      >
        {playerMode === "minimized" ? (
          // MINIMIZED PILL UI
          ...
          <div className="flex flex-col h-full text-emerald-400">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="mt-1 font-mono text-sm font-bold tracking-tight">LIVE STREAM FEED</p>
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="p-1 transition-colors rounded-full hover:bg-white/10 text-emerald-400/60 hover:text-emerald-400"
                  title={playerMode === "maximized" ? "Standard View" : "Expand"}
                >
                  <List size={14} />
                </button>
                <div
                        ...
                        {themes.map((t, i) => (
                          <button
                            ...
                            className={`w-full px-3 py-2.5 text-left text-[10px] font-mono flex items-center gap-2 hover:bg-white/10 transition-colors ${
                              i === themeIndex ? "bg-white/10 text-emerald-400" : "text-white/60"
                            }`}
                          >
                            <span>{t.icon}</span>
            ...
            {playerMode === "maximized" && (
              <div className="mt-4 pt-4 border-t border-white/10 flex-1 overflow-y-auto">
                ...
                <div className="space-y-2 font-mono text-[10px] text-emerald-400/60 pb-2">
                  <p>Connection: Stable ({Math.floor(Math.random() * 20) + 10}ms)</p>
